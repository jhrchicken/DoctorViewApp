...
<ul>
  ...
  <li>
    <b>기능 개발</b>
    <ul>
      <li>병원 키워드 검색, 병원 목록 표시, 병원 영업중 여부 표시, 병원 상세정보 표시, 병원 지도 표시, 소속 의사 등 상세정보 표시, 병원 찜, 별점과 해시태그를 통한 리뷰 작성/수정/삭제, 리뷰에 대한 답변 작성/수정/삭제, 리뷰 수정 여부 표시 등 <b>병원 검색 및 상세정보 기능</b></li>
      <li>의사</li>
      <li>Firebase 연동, 채팅 이력과 이전 대화 조회, 채팅 목록, 채팅방, 읽음 여부, 안읽은 메세지 개수, 채팅방 나가기, 채팅 날짜 시간 표시 등 모든 <b>채팅 기능</b></li>
...
|실용성|명확한 목표 및 비전과 실용성|16.5 / 20|
|개발능력|개발 프로그래밍 능력|16 / 20|
|발표|발표력|9 / 10|
