...
class ReserveItemHosp extends StatefulWidget {
  final int reserveIdx;
  const ReserveItemHosp({
    super.key,
    required this.reserveIdx,
  });

  @override
  State<ReserveItemHosp> createState() => _ReserveItemHospState();
}

class _ReserveItemHospState extends State<ReserveItemHosp> {
